...
const ProfileSetting = () => {
  ...
  useEffect(() => {
  getAPI(`dailyjoke/getSubscription/?user_id=${userId}`, accessToken, tokenType)
    .then((data) => {
  ...
  putAPI('dailyjoke/updatePassword', body, accessToken, tokenType)
   .then((data) => {
  ...
  const handleUpdateSubscription = async () => {
   ...
   putAPI('dailyjoke/updateSubscription', body, accessToken, tokenType)
   .then((data) => {
    setFormData(prevData => ({
        ...prevData,
        subscription_type: data['subscription_type'],
